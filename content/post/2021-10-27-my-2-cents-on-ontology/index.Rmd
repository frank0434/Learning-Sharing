...
what are already there on the web, and consolidated information in hands to 
engage with key stakeholders. The stakeholders engagement step is the most critical
and difficult one. Therefore, extra care might be needed to bring all stakeholders
on board, especially the data collection team. The data collection teams usually 
have the in-depth knowledge about the collection processes but often not necessary
expose to the whole life cycle of the data they have collected. A set of agreed
...
only limited by our imagination. We can develop a whole graphic knowledge database
from the raw ontologies or simply formatted the ontologies with [Web Ontology 
Language (OWL)](https://www.w3.org/TR/owl2-overview/). Then we can move onto 
another domain. 
